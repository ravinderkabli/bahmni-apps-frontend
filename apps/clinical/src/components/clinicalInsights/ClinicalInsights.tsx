...
const ClinicalInsights: React.FC<ClinicalInsightsProps> = ({
  ...
  // Auto-trigger generation when opened from the patient header "Generate Insights" button
  useEffect(() => {
    if (!autoGenerate || !selectedSpecialty || autoGeneratedRef.current || !canGenerate) return;
    autoGeneratedRef.current = true;
    handleGenerateInsights();
    // eslint-disable-next-line react-hooks/exhaustive-deps
  }, [autoGenerate, selectedSpecialty, canGenerate]);
